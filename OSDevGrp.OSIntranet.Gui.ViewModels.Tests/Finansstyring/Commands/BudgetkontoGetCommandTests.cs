...
namespace OSDevGrp.OSIntranet.Gui.ViewModels.Tests.Finansstyring.Commands
{
    ...
    public class BudgetkontoGetCommandTests
    {
        ...
        public void TestAtConstructorInitiererBudgetkontoGetCommand()
        {
            ...
            var command = new BudgetkontoGetCommand(fixture.Create<ICommand>(), fixture.Create<IFinansstyringRepository>(), fixture.Create<IExceptionHandlerViewModel>());
        ...
        public void TestAtConstructorKasterArgumentNullExceptionHvisFinansstyringRepositoryErNull()
        {
            ...
            var exception = Assert.Throws<ArgumentNullException>(() => new BudgetkontoGetCommand(fixture.Create<ICommand>(), null, fixture.Create<IExceptionHandlerViewModel>()));
            Assert.That(exception, Is.Not.Null);
            Assert.That(exception.ParamName, Is.Not.Null);
            Assert.That(exception.ParamName, Is.Not.Empty);
        ...
        public void TestAtConstructorKasterArgumentNullExceptionHvisExceptionHandlerViewModelErNull()
        {
            ...
            var exception = Assert.Throws<ArgumentNullException>(() => new BudgetkontoGetCommand(fixture.Create<ICommand>(), fixture.Create<IFinansstyringRepository>(), null));
            Assert.That(exception, Is.Not.Null);
            Assert.That(exception.ParamName, Is.Not.Null);
            Assert.That(exception.ParamName, Is.Not.Empty);
