...
namespace OSDevGrp.OSIntranet.Gui.ViewModels.Finansstyring.Commands
{
    ...
    /// </summary>
    public class KontoGetCommand : ViewModelCommandBase<IKontoViewModel>
    {
        ...
        public KontoGetCommand(ICommand dependencyCommand, IFinansstyringRepository finansstyringRepository, IExceptionHandlerViewModel exceptionHandlerViewModel)
