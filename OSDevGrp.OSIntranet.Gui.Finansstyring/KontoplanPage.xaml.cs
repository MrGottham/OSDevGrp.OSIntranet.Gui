...
{
    /// <summary>
    /// Page til en kontoplan for et givent regnskab.
    /// </summary>
    public sealed partial class KontoplanPage
    {
        #region Private variables

        private static readonly DependencyProperty RegnskabProperty = DependencyProperty.Register("Regnskab", typeof(IRegnskabViewModel), typeof(KontoplanPage), new PropertyMetadata(null));
        private static readonly DependencyProperty RegnskabslisteProperty = DependencyProperty.Register("Regnskabsliste", typeof(IRegnskabslisteViewModel), typeof(KontoplanPage), new PropertyMetadata(null));
        ...
        /// <summary>
        /// Danner en page til en kontoplan for et givent regnskab.
        /// </summary>
        public KontoplanPage()
        {
            InitializeComponent();
